...
export function PilaresSection() {
  return (
    <section className="py-32 bg-black px-4 md:px-10 overflow-hidden p-4">
          ...
          className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl md:scale-95 flex flex-col justify-between h-full min-h-[420px]">
            <div>
              ...
              <p className="font-montserrat text-zinc-400 text-md leading-relaxed">
                Atração qualificada de clientes através de dados e compra de tráfego otimizada.
              </p>
            </div>
            <div className="mt-6 overflow-hidden rounded-xl border border-zinc-800 bg-black">
              <img src={pilares1} alt="Mídia Paga" className="w-full h-auto object-cover opacity-70 hover:opacity-100 transition-opacity duration-300" />
            </div>
          </motion.div>
          ...
          className="bg-white border-4 border-white p-6 rounded-2xl md:scale-105 shadow-[0_0_50px_rgba(255,255,255,0.25)] flex flex-col justify-between h-full min-h-[420px]">
            <div>
              ...
              <p className="font-montserrat text-zinc-900 text-base font-medium leading-relaxed">
                Construção de autoridade corporativa e produção audiovisual premium.
              </p>
            </div>
            <div className="mt-6 overflow-hidden rounded-xl border border-zinc-200 bg-white">
              <img src={pilar2} alt="Posicionamento" className="w-full h-auto object-cover grayscale" />
            </div>
          </motion.div>
      ...
      transition={{ duration: 0.8, delay:0.3, ease: "easeOut" }}
          className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl md:scale-95 flex flex-col justify-between h-full min-h-[420px]">
            <div>
              ...
              <p className="font-montserrat text-zinc-400 text-md leading-relaxed">
                Ecossistemas digitais e ecossistemas de alta taxa de conversão.
              </p>
            </div>
            <div className="mt-6 overflow-hidden rounded-xl border border-zinc-800 bg-black">
              <img src={pilar3} alt="Engenharia Web" className="w-full h-auto object-cover opacity-70 hover:opacity-100 transition-opacity duration-300" />
            </div>
          </motion.div>
        </div>
      </div>
      <div className="flex justify-center pt-4">
        <Button variantClass="bg-white"/>
      </div>
    </section>
  );
}