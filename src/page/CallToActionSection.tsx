...
export function CallToActionSection() {
  return (
    <div className="bg-black py-32 p-4" id="Contato">
      <div className="text-white flex flex-col gap-6">
        ...
        className="text-center text-md leading-5">
          Se a sua empresa está pronta para atrair mais clientes, <br /> passar
          mais profissionalismo e vender em escala, nós temos a estratégia.
        </motion.p>
        <div className="text-center">
          <Button variantClass="bg-white text-black" />
        </div>
      </div>
